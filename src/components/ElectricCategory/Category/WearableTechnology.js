...
function WearableTechnology() {
  return (
    <div className="wearable-technology__container">
      ...
      <div className="wearable-technology__top-rated-container">
        <div className="wearable-technology__heading">
          <h1>Top rated</h1>
        </div>
        <div className="wearable-technology__flex-box">
          <div className="wearable-technology__product-card">
      ...
      <div className="wearable-technology__hot-new-container">
        <div  className="wearable-technology__heading">
      ...
      <div className="wearable-technology__recommended-container">
        <div  className="wearable-technology__heading">
      ...
      <div className="wearable-technology__under-container">
        <div className="wearable-technology__heading">
          <h1>Under $25</h1>
        </div>
        <div className="wearable-technology__flex-box">
      ...
      <div className="wearable-technology__best-seller-container">
        <div className="wearable-technology__heading">
          <h1>Best sellers</h1>
        </div>
        <div className="wearable-technology__flex-box">
      ...
      <div className="wearable-technology__brand-category">
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/img16/wearable-technology/content-grid/landing-page/wt_brand-farm_androidwear.png" alt="technology-brand" />
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/img16/wearable-technology/content-grid/landing-page/wt_brand-farm_fitbit.png" alt="technology-brand" />
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/img16/wearable-technology/content-grid/landing-page/wt_brand-farm_fossil.png" alt="technology-brand" />
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/img16/wearable-technology/content-grid/landing-page/wt_brand-farm_garmin.png" alt="technology-brand" />
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/img16/wearable-technology/content-grid/landing-page/wt_brand-farm_misfit.png" alt="technology-brand" />
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/img16/wearable-technology/content-grid/landing-page/wt_brand-farm_motorola.png" alt="technology-brand" />
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/img16/wearable-technology/content-grid/landing-page/wt_brand-farm_samsung.png" alt="technology-brand" />
        <img src="https://images-na.ssl-images-amazon.com/images/G/01/wilcod/TileLogos-6.jpg" alt="technology-brand" />
      </div>
      <div className="wearable-technology__featured-deals-container">
        <div className="wearable-technology__heading">
      ...
      <div className="wearable-technology__lightning-deals-container">
        <div className="wearable-technology__heading">
      ...
      <div className="wearable-technology__most-wished-container">
        <div className="wearable-technology__heading">
      ...
      <div className="wearable-technology__most-gifted-container">
        <div className="wearable-technology__heading">
          <h1>Most gifted</h1>
        </div>
        <div className="wearable-technology__flex-box">
