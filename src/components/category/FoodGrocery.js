      ...
      <div className="grocery-food__container">
        ...
        <div className="grocery-food__container-flex-grid">
          ...
          <div className="grocery-food__container-3-grid">
            <div className="grocery-food__container-3-grid-grid-1">
              <ElectronicsProductTemplate
                id="123123"
                title=""
                price={120.99}
            ...
            <div className="grocery-food__container-3-grid-grid-2">
              <ElectronicsProductTemplate
                id="123123"
                title=""
                price={120.99}
            ...
            <div className="grocery-food__container-3-grid-grid-3">
              <ElectronicsProductTemplate
                id="123123"
                title=""
                price={120.99}
