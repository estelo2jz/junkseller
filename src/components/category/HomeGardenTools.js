      ...
      <div className="home-garden-tools__container">
        ...
        <div className="home-garden-tools__container-flex-grid">
          ...
          <div className="home-garden-tools__container-3-grid">
            <div className="home-garden-tools__container-3-grid-grid-1">
              <ElectronicsProductTemplate
                id="123123"
                title=""
                price={119.99}
            ...
            <div className="home-garden-tools__container-3-grid-grid-2">
              <ElectronicsProductTemplate
                id="123123"
                title=""
                price={119.99}
            ...
            <div className="home-garden-tools__container-3-grid-grid-3">
              <ElectronicsProductTemplate
                id="123123"
                title=""
                price={119.99}
